...
export const DEFAULT_UI_STRINGS: { key: string; fr: string; en: string }[] = [
  ...
  {
    key: 'contactPage.subtitle',
    fr: "Une question, une demande d'information ou un projet de voyage sur mesure ? Notre équipe est là pour vous aider.",
    en: 'A question, a request for information, or a custom trip project? Our team is here to help.',
  },
  { key: 'contactPage.formHeading', fr: 'FORMULAIRE DE CONTACT', en: 'CONTACT FORM' },
  { key: 'contactPage.messageLabel', fr: 'Votre message', en: 'Your message' },
  { key: 'contactPage.messagePlaceholder', fr: 'Comment pouvons-nous vous aider ?', en: 'How can we help?' },
  { key: 'contactPage.reasonLabel', fr: 'Motif du message', en: 'Reason for contact' },
  { key: 'contactPage.reasonGeneral', fr: 'Question générale', en: 'General question' },
  { key: 'contactPage.reasonTrip', fr: 'Organiser mon voyage', en: 'Plan my trip' },
  { key: 'contactPage.reasonPress', fr: 'Presse et médias', en: 'Press & media' },
  { key: 'contactPage.reasonPartnership', fr: 'Partenariat', en: 'Partnership' },
  { key: 'contactPage.reasonOther', fr: 'Autre', en: 'Other' },
  { key: 'contactPage.submitBtn', fr: 'Envoyer le message', en: 'Send message' },
  { key: 'contactPage.note', fr: 'Nous répondons généralement sous 24 à 48 heures.', en: 'We usually reply within 24 to 48 hours.' },
  {
    key: 'contactPage.successMsg',
    fr: 'Votre message a bien été envoyé. Merci !',
    en: 'Your message has been sent. Thank you!',
  },
  {
    key: 'contactPage.guideLink',
    fr: "Besoin d'infos pratiques avant de partir ? Consultez notre guide du voyageur →",
    en: "Need practical info before you go? Check out our traveler's guide →",
  },
